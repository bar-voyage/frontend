...
export const Map = ({ navigation }) => {
  ...
  const data = [
    {
      bar_id: 'd852db35-8be9-42d2-b894-14f100036e68',
      name: 'SEH',
      distance: '0.2 mi',
      categories: [''],
      image_url:
        'https://gwtoday.gwu.edu/sites/g/files/zaxdzs1531/f/styles/gw_editorial_article_full/public/image/SEH17_SEH_UP_2015-WLA_6446_1080x.jpg?itok=9egdRwXz',
      avg_stars: 5,
    },
    {
