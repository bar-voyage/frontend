...
const DescriptorBadge = props => {
  const { text, onClickAdj } = props;
...
export const BarInfo = ({ route, navigation }) => {
  ...
  const [barAdj, setBarAdj] = useState([]);

  const descriptions = ["crowded", "good music", "fun", "cheap drinks", "loud", "dirty", "boring", "expensive", "young crowd"]
  ...
  const sendCheckInRating = () => {
    ...
    // Send bar descriptions to backend To-DO: 
    axiosBackendInstance
      .post('/rating', {
        bar_id: bar_id,
        num_stars: rating,
  ...
  const onClickAdj = (i) => {
    // setBarAdj(barAdj.concat([descriptions[i]])); 
    setBarAdj([descriptions[i]]);
    console.log('bar descr', barAdj);
  }
              ...
              <HStack space={4}>
                {Array(9)
                  ...
                  .map((_, i) => (
                    <DescriptorBadge
                      text={descriptions[i]}
                      onClickAdj={onClickAdj(i)}
                    />
                  ))
                }


                {/* <DescriptorBadge text="crowded" val="1" />
                <DescriptorBadge text="good music" val="2" />
                <DescriptorBadge text="fun" val="3" />
              </HStack>
              <HStack space={4} pt={4}>
                <DescriptorBadge text="cheap drinks" val="4" />
                <DescriptorBadge text="loud" val="5" />
                <DescriptorBadge text="dirty" val="6" />
              </HStack>
              <HStack space={4} pt={4} pb={4}>
                <DescriptorBadge text="boring" val="7" />
                <DescriptorBadge text="expensive" val="8" />
                <DescriptorBadge text="young crowd" val="9" /> */}
